...
namespace PHYS
{
    ...
    public:
        ...
        virtual void create(IWorldPtr world, const CCarDef& carro) = 0;
        virtual void destroy() = 0;
        virtual void reset() = 0;
        virtual void init_simulation_vars() = 0;
        virtual void simulation_step() = 0;
        virtual bool simulation_step_get_dead() = 0;
        virtual void measure(IWorldPtr world, const CCarDef &carro, float max_t) = 0;
        virtual void init() = 0;
        virtual void fill_gr_car(GUI::IGrCar& car) = 0;
        virtual GA::fitness_params_t get_ga_fitness_params() = 0;
        [[nodiscard]] virtual vec2f_t getMassCenter() const = 0;
