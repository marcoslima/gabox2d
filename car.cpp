...
void CCar::_create(void)
{
	...
	car_def.R1 = DecodeRoda(&_genes[ 0]);
	car_def.R2 = DecodeRoda(&_genes[18]);
	car_def.P1 = DecodeRoda(&_genes[36]);
	car_def.P2 = DecodeRoda(&_genes[54]);
	_trqA = DecodeGen(nLen,&_genes[57],-dFp,dFp);
	_trqB = DecodeGen(nLen,&_genes[60],-dFp,dFp);
	_trqC = DecodeGen(nLen,&_genes[63],-dFp,dFp);
	_trqD = DecodeGen(nLen,&_genes[66],-dFp,dFp);
