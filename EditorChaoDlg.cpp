...
void DragDouble(const char* label, void* p_data, float v_speed, const void* p_min, const void* p_max, const char* format)
{
...
void DragSigned(const char* label, void* p_data, float v_speed, const void* p_min, const void* p_max, const char* format)
{
	ImGui::PushItemWidth(-1.0e-38f);
